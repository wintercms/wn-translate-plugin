...
class_alias(Winter\Translate\Plugin::class, RainLab\User\Plugin::class);

class_alias(Winter\Translate\Classes\EventRegistry::class, RainLab\Translate\Classes\AuthManager::class);
