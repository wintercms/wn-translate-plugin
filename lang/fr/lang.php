...
return [
    ...
    'messages' => [
        ...
        'scan_messages_purge_deleted_label' => 'Purger les messages manquants après l\'analyse',
        'scan_messages_purge_deleted_help' => 'Si cette option est cochée, tous les messages que le scanner n\'a pas trouvés, y compris leurs traductions, seront supprimés une fois l\'analyse terminée. Il n\'est pas possible de revenir en arrière !',
        ...
        'found_help' => 'Indique si des erreurs se sont produites au cours de l\'analyse.',
        'found_title' => 'Erreurs d\'analyse',
    ],
];
